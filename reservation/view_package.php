...
$review = $conn->query("SELECT r.*,concat(firstname,' ',lastname) as name FROM `rate_review` r inner join clients u on r.user_id = u.id where r.package_id='{$id}' order by unix_timestamp(r.date_created) desc ");
...
<section class="page-section">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <div id="tourCarousel"  class="carousel slide" data-ride="carousel" data-interval="1800">
            ...
            <div class="col-md-7">
                ...
                <hr class="border-warning">
                <!-- <small class='text-muted'>Inclusions: <?php echo $tour_location ?></small> -->
                <h4>Details</h4>
...
<script>
    ...
    $(document).ready(function(){
		$('#package-form').submit(function(e){
			...
			start_loader();
			$.ajax({
				url:_base_url_+"classes/Master.php?f=book_inclusion",
				...
				success:function(resp){
					if(typeof resp =='object' && resp.status == 'success'){
						location.href = "./?page=view_package";
					}else{
						alert_toast("An error occured",'error');
						end_loader();
                        console.log(resp)
