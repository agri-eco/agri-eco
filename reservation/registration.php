        ...
        <div class="row  align-items-center h-100">
            ...
            <div class="col-lg-5 border-right">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" pattern="^\d{11}$" class="form-control form-control-sm form" placeholder="09xxxxxxxxx"name="contact" required>
                </div>
                <div class="form-group">
            ...
            <div class="col-lg-7">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control form-control-sm form"  minlength="7" name="password" required>
                </div>
