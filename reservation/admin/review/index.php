        ...
        <div class="container-fluid">
            <table class="table table-stripped text-dark">
                ...
                <tbody>
                    <?php
                    $i = 1;
                    $qry = $conn->query("SELECT r.*,concat(u.firstname,' ',u.lastname) as name, p.title FROM `rate_review` r inner join clients u on .u.id = r.user_id inner join `packages` p on p.id = r.package_id order by unix_timestamp(r.date_created) desc ");
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <p class="truncate-1 m-0"><?php echo $row['rate'] ?></p>
                            </td>
                            <td>
                                <p class="truncate-1 m-0" title="<?php echo $row['review'] ?>"><?php echo $row['review'] ?></p>
                            </td>
                            <td align="center">
