		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group d-flex justify-content-center">
					<img src="<?php echo site_url . $_settings->info('logo') ?>" alt="" id="cimg" class="img-fluid img-thumbnail">
				</div>
				<div class="form-group">
				...
				<div class="form-group d-flex justify-content-center">
					<img src="<?php echo site_url . $_settings->info('cover') ?>" alt="" id="cimg2" class="img-fluid img-thumbnail">
				</div>
			</form>
		</div>
