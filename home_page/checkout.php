...
$where = "";
if (count($brands) > 0)
    $where = " c.id in (" . implode(",", $brands) . ") and ";
$i = 1;
$total = 0;
$lala = implode(",", $brands);
$qry = $conn->query("SELECT c.*,p.product_name,i.price,p.id as pid from `cart` c inner join `inventory` i on i.id=c.inventory_id inner join products p on p.id = i.product_id where {$where} c.client_id = " . $_settings->userdata('id'));
    ...
    <div class="container">
        <div class="card rounded-0">
            ...
            <form action="" id="place_order">
                <input type="hidden" name="amount" value="<?php echo isset($total) ? number_format($total, 2) : 0.00 ?>">
                <input type="hidden" name="id[]" value="<?php echo $lala ?>">
                ...
                <div class="row row-col-1 justify-content-center">
                    <div class="col-6">
                        ...
                        <h3 class="text-center address-holder">Delivery Address</h3>
                        <h3 class="text-center method-holder">Pick-Up Address</h3>
                        ...
                        <div class="form-group col address-holder">
                            <label for="" class="control-label">Landmark, Street Name, House No.</label>
                            <textarea id="delivery_address" cols="30" rows="3" name="delivery_address" class="form-control" placeholder="Landmark, Street Name, House No." style="resize:none" required></textarea>
                        </div>
                        <!-- <div class="form-group address-holder">
                            <label for="name" class="control-label">Street Name, Building, House No.</label>
                            <input type="text" class="form-control form-control-sm form" row="3" name="delivery_address" required>
                        </div> -->
                        <div class="pick-up">
                            <!-- <input type="hidden" name="delivery_address" value="Cavite State University Main Campus - Bancod I, Indang, Cavite" aria-label="Disabled input example" disabled readonly> -->
                            <!-- <input type="hidden" name="city" value="Cavite State University Main Campus - Bancod I, Indang, Cavite" aria-label="Disabled input example" disabled readonly>
                            <input type="hidden" name="province" value="Cavite State University Main Campus - Bancod I, Indang, Cavite" aria-label="Disabled input example" disabled readonly> -->
                        ...
                        <div class="col">
                            <span>
                                <h4><b>Total: </b>₱ <?php echo isset($total) ? number_format($total, 2) : 0.00 ?></h4>
                            </span>
                        </div>
                        <hr>
                        ...
                        <div class="d-flex w-100 justify-content-between ">
                            <button class="btn btn-flat btn-lg btn-primary method-holder1"><i class="bi-cart-fill me-1 fa fa-truck">Cash on Delivery</i></button>
                        </div>
                        <div class="d-flex w-100 justify-content-between ">
                            <button class="btn btn-flat btn-lg btn-primary method-holder"><i class="bi-cart-fill me-1 	far fa-credit-card">Cash on Pick-up</i></button>
                        </div>
...
<script>
    $('.pick-up').hide()
    $('.method-holder').hide()
    $("select[name='province']").attr('required', true)
    $("select[name='city']").attr('required', true)
    $("select[name='barangay']").attr('required', true)
    $(function() {
        $('[name="order_type"]').change(function() {
            if ($(this).val() == 2) {
                $('.address-holder').hide('slow')
                // $('.address-holder').prop('required', false);
                ...
                $("select[name='barangay']").removeAttr('required')
                $('#delivery_address').val('Cavite State University Main Campus -')
            } else {
                $("select[name='province']").attr('required', true)
                $("select[name='city']").attr('required', true)
                $("select[name='barangay']").attr('required', true)
                ...
                // $('.address-holder').prop('required', true);
        ...
        $('#place_order').submit(function(e) {
            ...
            $.ajax({
                ...
                error: err => {
                    console.log(err)
                    alert_toast("Please Enter Delivery Address", "warning")
                    end_loader();
                },
