    ...
    <div class="card-body">
        <form action="" id="package-form">
            ...
            <div class="form-group d-flex pr-2">
                <div>
                    <label for="min" class="control-label">Minimum Pax</label>
                    <input type="number" step="any" class="form form-control" name="min" value="<?php echo isset($min) ? $min : '1'; ?>">
                </div>
                <div>
                    <label for="min" class="control-label">Maximum Pax</label>
                    <input type="number" step="any" class="form form-control" name="max" value="<?php echo isset($max) ? $max : '1'; ?>">
                </div>
            </div>
            <!-- <div class="form-group">
