        ...
        <form action="" id="product-form">
            ...
            <div class="form-group">
                ...
                <select name="category_id" id="category_id" class="custom-select select2" required>
                    <option value=""></option>
                    <?php
                    $qry = $conn->query("SELECT * FROM `categories` where status='1' order by category asc");
            ...
            <div class="form-group">
                ...
                <textarea name="department" id="" cols="30" rows="2" readonly class="form-control form no-resize">Cavite State University</textarea>
                <!--              <textarea name="department" id="" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($department) ? $department : ''; ?></textarea> -->
            </div>
            <div class="form-group">
