			...
			<div class="container-fluid">
				<table class="table table-bordered table-stripped">
					...
					<tbody>
						<?php
						$i = 1;
						$qry = $conn->query("SELECT i.*,p.product_name as product,p.department as pdepartment from inventory i inner join products p on p.id = i.product_id order by unix_timestamp(i.date_created) desc ");
						...
						?>
							<tr>
								...
								<td>
									<p class="m-0"><small><b>Name:</b> <?php echo $row['product'] ?></small></p>
									<p class="m-0 truncate"><b>Manufacturer:</b> <?php echo $row['pdepartment'] ?></p>
								</td>
