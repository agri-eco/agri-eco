...
if (isset($_GET['id']) && $_GET['id'] > 0) {
    $qry = $conn->query("SELECT * from `image` where id = '{$_GET['id']}' ");
    if ($qry->num_rows > 0) {
...
<div class="card card-outline card-info">
    ...
    <div class="card-body">
        <form action="" id="package-form">
            ...
            <!-- <div class="form-group">
				<label for="tour_location" class="control-label">Inclusions</label>
            ...
            <div class="form-group">
                <label for="description" class="control-label">Image Caption</label>
                <input type="text" name="description" class="form-control form-control-sm" value="<?php echo isset($description) ? $description : ''; ?>" />
            </div>
            <div class="form-group">
    ...
    <div class="card-footer">
        ...
        <a class="btn btn-flat btn-default" href="?page=image">Cancel</a>
    </div>
</div>
<script>
    ...
    $(document).ready(function() {
        ...
        $('#package-form').submit(function(e) {
            ...
            start_loader();
            $.ajax({
                url: _base_url_ + "classes/Master.php?f=save_package1",
