            ...
            <div>
                <form action="" id="update_account">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" pattern="^\d{11}$" class="form-control form-control-sm form" placeholder='09xxxxxxxxx' name="contact" value="<?php echo $_settings->userdata('contact') ?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control form" rows='3' name="default_delivery_address" required><?php echo $_settings->userdata('default_delivery_address') ?></textarea>
                    </div>
                    <div class="form-group">
