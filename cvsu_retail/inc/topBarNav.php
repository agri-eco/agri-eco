  ...
  <div class="container-fluid px-4 px-lg-5 ">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
        <li class="nav-item"><a class="nav-link" aria-current="page" href="./">All Products</a></li>
        <?php
        ...
        ?>
          ...
          <?php else : ?>
            <li class="nav-item dropdown">
              <a class="nav-link" id="navbarDropdown<?php echo $crow['id'] ?>" href="./?p=products&c=<?php echo md5($crow['id']) ?>" role="button" aria-expanded="false"><?php echo $crow['category'] ?></a></a>
